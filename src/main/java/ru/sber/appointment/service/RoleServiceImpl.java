...
import ru.sber.appointment.exception.NoSuchRoleException;
...
public class RoleServiceImpl implements RoleService {
    ...
    public Role findById(Long roleId) {
        return roleRepository.findById(roleId).orElseThrow(()->new NoSuchRoleException("Не найдено роли с id " + roleId));
    }
}
